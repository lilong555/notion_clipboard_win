...
void PrintHelp()
{
    std::cout << "Notion Clipboard Win\n\n"
              ...
              << "  notion_clipboard_win.exe --test-upload-url URL        使用配置页内容测试保存一次\n\n"
              << "  notion_clipboard_win.exe --open-upload-center-url URL 打开保存记录\n\n"
              << "  notion_clipboard_win.exe --retry-failed-job-url URL   重试单个失败任务\n\n"
              << "  notion_clipboard_win.exe --retry-failed-uploads-url URL 重试失败队列任务\n\n"
