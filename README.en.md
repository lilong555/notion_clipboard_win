...
CTest runs the built-in self-test plus Notion and Obsidian long-form conversions of `test/bf.txt`. CI also runs release-guard and installer-guard checks; before submitting changes, run at least the CTest command above.
